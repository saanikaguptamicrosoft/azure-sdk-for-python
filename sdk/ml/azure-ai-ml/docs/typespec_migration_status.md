...
| 2 | 2021-10-01-dataplanepreview | Not Started ⚪ | — | TSP-gen unblocked (`Id` discriminator collision, mechanical fix); see [typespec_generation_status.md](typespec_generation_status.md) row 2 ||
...
| 8 | 2023-04-01-preview | Not Started ⚪ | — | TSP-gen unblocked (`uri_folder` collision, fix pattern from Kashif's GA TSP); see [typespec_generation_status.md](typespec_generation_status.md) row 8 ||
| 9 | 2023-06-01-preview | Not Started ⚪ | — | TSP-gen unblocked (same `uri_folder` fix as row 8); see [typespec_generation_status.md](typespec_generation_status.md) row 9 ||
| 10 | 2023-08-01-preview | Not Started ⚪ | — | TSP-gen unblocked (`uri_folder` + `PatchModel = void` fix from Kashif's GA TSP); see [typespec_generation_status.md](typespec_generation_status.md) row 10 ||
| 11 | 2024-01-01-preview | Not Started ⚪ | — | TSP-gen unblocked (`uri_folder` + `PatchModel` + 5 ops files via Kashif's preview TSP pattern); see [typespec_generation_status.md](typespec_generation_status.md) row 11 ||
